...
for jj,indRocket in enumerate(rockSweep):   
    ...
    for ii,mLaunch in enumerate(mSeparated):
        ...
        dvReq   = 2
        engMain = cf.Engine(470, 23212, 5.5, 'Biprop', 'NotCryo')
        ...
        #FuelTanks = cf.TankSet("Hydrogen", "Stainless", 1, 2.05, 300000, Mission.mPropTotalFuel)    
...
legString=('Goal','Scout','Juno','Vanguard','Nike',) # initialize the list for the legend
fig1 = plt.figure()
plt.plot([2000, 20000], [750, 750], color='k')
